package com.xbk.spring.httpclient.core.httpclient;
...
public class HttpClientPoolManager {
    ...
    private static final RequestConfig DEFAULT_CONFIG = RequestConfig.custom()
            .setConnectTimeout(Common.DEFAULT_CONNECT_TIMEOUT)
            .setConnectionRequestTimeout(Common.DEFAULT_CONNECT_REQUEST_TIMEOUT)
            .setSocketTimeout(Common.DEFAULT_SOCKET_TIMEOUT)
    ...
    static {
        ...
        poolingHttpClientConnectionManager.setMaxTotal(Common.DEFAULT_MAX_TOTAL);
        poolingHttpClientConnectionManager.setDefaultMaxPerRoute(Common.DEFAULT_MAX_PER_ROUTE);
