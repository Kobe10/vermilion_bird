...
public abstract class AbstractServiceImpl<T extends BaseEntityOnlyId> {
    ...
    protected static Integer ID_ERROR_CODE = 509;
    ...
    public static void throwBizException(Long id) {
        throw new HelperException(ID_ERROR_CODE, String.format(RESULT_MESSAGE, id));
    }
